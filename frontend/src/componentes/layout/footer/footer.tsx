      ...
      <div className="ph-container">
        <div className="ph-footerGrid">
          ...
          <div>
            ...
            <ul className="ph-footerLinks">
              <li><a href="https://wa.me/5492473417518" target="_blank" rel="noopener noreferrer">WhatsApp</a></li>
        ...
        <div className="ph-footerBottom">
          <span>© {currentYear} Petit Accesorios. Todos los derechos reservados.</span>
